import {
  ...
  const UserProfile = ({ item, userId }) => {
    ...
    const sendConnectionRequest = async (currentUserId, selectedUserId) => {
      try {
        const response = await fetch("http://10.0.2.2:8000/api/connection-request", {
          method: "POST",
          headers: {
      ...
      >
        <View style={{ justifyContent: "center", alignItems: "center" }}>
          <Image
            ...
            source={{ uri: item?.profileImage|| "https://th.bing.com/th/id/OIP.1nWRQ7r_1nEVJ6sdz_zwkwHaE8?w=227&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7" }}
          />
        </View>
